(function() {
  ...
  this.Phrase_parser = Phrase_parser = class Phrase_parser {
    //---------------------------------------------------------------------------------------------------------
    parse(sentence) {
      var R, adjectives, alternative, alternatives, depth, disjunct, element_clause, ladjectives, lphrase, noun, noun_entry, phrase, ref, ref1, words;
        ...
        for (element_clause of ref1) {
          ...
          if (element_clause.elements != null) {
            if (element_clause.elements.elements != null) {
              throw new E.Nested_elements_clause('^Phrase_parser.parse@1^', sentence);
            }
            ({
              phrase: lphrase
