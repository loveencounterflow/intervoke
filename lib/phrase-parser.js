(function() {
  'use strict';
  var E, GUY, Phrase_parser, debug, get_base_types, help, info, rpr, urge, warn;
  ...
  this.Phrase_parser = Phrase_parser = class Phrase_parser {
    ...
    set_vocabulary(vocabulary) {
      return GUY.props.hide(this, 'vocabulary', vocabulary);
    }
    ...
    * _walk_disjuncts(words) {
    ...
    _get_vocabulary_entry(phrase, word, role = null) {
      var R, phrase_txt;
      if ((R = this.vocabulary[word]) == null) {
