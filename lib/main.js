  ...
  this.Word_prompter = Word_prompter = (function() {
    class Word_prompter extends Prompter {
      ...
      constructor(cfg) {
        ...
        this.cfg = this.__types.create.word_prompter_cfg(cfg);
        return void 0;
      }
      ...
      __get_handler(accessor) {
        ...
        debug('^__get_handler@23234^', rpr(accessor), this[accessor] != null);
