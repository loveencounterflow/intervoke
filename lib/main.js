(function() {
  'use strict';
  var E, GUY, Intervoke, Phrase_parser, Phrase_prompter, Prompter, debug, get_base_types, help, info, rpr, urge, warn;
  ...
  this.Intervoke = Intervoke = (function() {
    ...
    class Intervoke extends Prompter {
      //---------------------------------------------------------------------------------------------------------
      constructor(cfg) {
        super();
  ...
  //===========================================================================================================
  this.Phrase_prompter = Phrase_prompter = class Phrase_prompter extends Intervoke {
    //---------------------------------------------------------------------------------------------------------
